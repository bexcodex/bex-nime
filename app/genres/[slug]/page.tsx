...
export default function GenreDetailPage({ params }: { params: { slug: string } }) {
  ...
  const { data, error, isLoading } = useSWR(`/api/v1/genres/${slug}/${page}`, fetcher)
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <h1 className="text-4xl font-bold mb-8 text-balance capitalize">{slug.replace(/-/g, " ")} Anime</h1>
        ...
        {isLoading ? (
          ...
          <div className="flex items-center justify-center min-h-[40vh]">
            <p className="text-muted-foreground">Failed to load anime</p>
          </div>
        ) : (
          <>
